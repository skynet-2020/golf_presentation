...
We study landscape sustainability, which focuses on studying and improving the relationships between landscape pattern and human well-being. To understand how we think about sustainability, you need to understand the landscape perspective.
...
3. **Aesthetic services.** The aesthetic features of harmony, balance, rhythm, proportion, and emphasis are highlighted by golf course features. <span style="color: red;"> [COLLAGE OF PHOTOS: Beautiful courses] </span>
4. **Recreation** In 2019, golfers in the Phoenix area played approximately 5.8 million rounds of golf, which translates to roughly 20 million hours of recreation time. Much of the time spent on golf courses is with friends or associates during casual rounds, golf leagues, or ameteur tournaments, which fosters good social relations and sense of place for Phoenix residents. <span style="color: red;"> [COLLAGE OF PHOTOS: Golfers on the course] </span>

Together, these benefits have high monetary values. The Arizona Alliance for Golf report estimated that the golf industry drove 4.6 billion USD worth of economic activity across the state of Arizona in the year 2019.

<br>

#### Golf Course Water Use 

We found that golf courses in the Phoenix area collectively use an approximate annual average of 80,000 AF of water, which accounts for roughly 50% of industrial water use and 3–4% of the total water use in the Phoenix Active Management Area.  The largest source of water for golf courses is groundwater, which is being depleted more rapidly than it is being recharged in the Phoenix area. This amount of water use by golf courses in a dryland region is quite substantial and not environmentally sustainable because of the water shortages in the region. Thus, water saving measures must be implemented. One way to reduce golf course water use is turf reduction projects. Here are photos from a turf reduction project at Papago Golf Club.<span style="color: red;"> [PHOTOS: Papago redesign] </span> 
...
We have developed a 'positive vision' for desert golf course design that we would like to present. Positive visions are future scenarios designed to inspire motivation towards sustainability solutions in urban settings, and they can be a tool for bringing together diverse groups of stakeholders to discuss sustainability solutions. 

[Details about the positive vision]

Here is what we seek to accomplish:

1. Share an example of our sustainability recommendations
2. Receive feedback from golf industry professionals about our sustainability recommendations.

We hope to create a dialogue among ourselves and other groups involved in city planning and the golf industry to improve regional sustainability.

#### Description of the activity

1. Explain the positive vision (5 mins)
2. 
    * What are the barriers to designing a golf course like this? Would golfers want to play the course? Would the course be profitable? Is anything like this being done?
